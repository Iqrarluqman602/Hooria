...
export const experiences = [
    {
        title: "IT Teacher",
        company_name: " Korean Computer Academy",
        icon: starbucks,
        iconBg: "#accbe1",
        date: "March 2018 - Present ",
        points: [
            "6 years’ experience as IT Teacher in Korean Computer Academy.",
          
        ],
    },
    {
        title: "IT Teacher",
        company_name: "Infotics Institute of Computer",
        icon: tesla,
        iconBg: "#fbc3bc",
        date: "Jan 2021 - Feb 2022",
        points: [
            "1 year experience as IT Teacher in Infotics Institute of Computer Education.",
    ...
    },
    {
        ...
        company_name: "Pixuel Digitizing & Web Expert",
        icon: meta,
        iconBg: "#a2d2ff",
